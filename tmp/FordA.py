...
x_train, y_train = reader("/home/uu/FordA/FordA_TRAIN.tsv")
...
trainSample, trainLabel = combine(x_train, y_train)
valSample, valLabel = combine(x_test, y_test)
...
def train(dataset,
    ...
    trainIter.dataset.allSample = trainSample
    trainIter.dataset.allLabel = trainLabel
    valIter.dataset.allSample = valSample
    valIter.dataset.allLabel = valLabel
