...
# x_test, y_test = reader("/home/uu/FordA/FordA_TRAIN.tsv")
x_test, y_test = reader("/home/uu/FordA/FordA_TEST.tsv")
...
testSample, testLabel = combine(x_test, y_test)
...
def parse_args():
    ...
    netPath = os.path.join('result', 'train', '20241211.210752_YOLOv8_1D', 'best_params.pt')
    netPath = os.path.join('result', 'train', '20241211.211522_YOLOv8_1D', 'best_params.pt')
    netPath = os.path.join('result', 'train', '20241211.212610_YOLOv8_1D', 'best_params.pt')
    netPath = os.path.join('result', 'train', '20241213.132333_YOLOv8_1D', 'best_params.pt')
    weight = netPath
...
def test(dataset,
    ...
    testIter.dataset.allSample = testSample
    testIter.dataset.allLabel = testLabel
